...
const animatedIcons = [
  {
    icon: Workflow,
    className:
      "left-[10%] top-[20%] animate-float-slow text-primary-glow opacity-30",
    size: 64,
  ...
  },
  {
    icon: User2,
    className:
      "left-[70%] top-[10%] animate-float-medium text-white opacity-20",
    size: 56,
  ...
  },
  {
    icon: Waypoints,
    className:
      "left-[30%] top-[65%] animate-float-fast text-primary opacity-25",
    size: 72,
  ...
  },
  {
    icon: Waypoints,
    className:
      "left-[80%] top-[60%] animate-float-medium text-primary-glow opacity-20",
    size: 48,
  ...
  },
  {
    icon: Waypoints,
    className:
      "left-[55%] top-[40%] animate-float-slow text-white opacity-15",
    size: 40,
  ...
  },
  {
    icon: Wifi,
    className:
      "left-[20%] top-[80%] animate-float-medium text-primary opacity-20",
    size: 60,
  ...
  },
  {
    icon: CalendarSync,
    className:
      "left-[60%] top-[75%] animate-float-fast text-white opacity-15",
    size: 52,
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-gradient-hero overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        {animatedIcons.map(({ icon: Icon, className, size, delay }, i) => (
          <Icon
            key={i}
            ...
            <div className="relative bg-gradient-card rounded-2xl p-8 shadow-2xl border border-white/10">
              ...
              <div className="bg-enterprise rounded-lg p-6 mb-4">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-enterprise-foreground">
                    Live Operations Dashboard
                  </h3>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-sm text-enterprise-foreground/70">
                      Real-time
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="bg-enterprise-muted rounded-lg p-4 text-center">
                    ...
                    <div className="text-xs text-enterprise-foreground/70">
                      Active Devices
                    </div>
                  </div>
                  <div className="bg-enterprise-muted rounded-lg p-4 text-center">
